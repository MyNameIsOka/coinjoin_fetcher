...
function getCoinJoins(dateStart, dateEnd) {
    return __awaiter(this, void 0, void 0, function () {
        var DateStart, ddStart, mmStart, yyyyStart, dateStartString, DateEnd, ddEnd, mmEnd, yyyyEnd, dateEndString, unixStart, unixEnd, now, today, unixToday, dd, mm, yyyy, todayString, unixDate, temp, priceHistory, date, url, response, url, response, date, e_1, output, blockhash, diffSecs, diffBlocks, targetBlockHeight, blockstat, coinjoins, found, iMax, denomination, counterRounds, date, CoinJoinTx, _i, _a, i, cjCount, _loop_1, _b, coinjoins_1, entries, _c, found_1, entry, calculate;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    dateEndString = ddEnd.substr(-2) + '-' + mmEnd.substr(-2) + '-' + yyyyEnd;
                ...
                case 3:
                    ...
                    url = "https://api.coingecko.com/api/v3/coins/bitcoin/history?date=" + dateEndString;
                    return [4 /*yield*/, axios_1["default"].get(url, { timeout: 10000 })];
                case 4:
                    response = _d.sent();
                ...
                case 16:
                    ...
                    CoinJoinTx = [];
                    coinjoins = [];
                    for (_i = 0, _a = output.tx; _i < _a.length; _i++) {
                        CoinJoinTx = _a[_i];
                    ...
                    for (_b = 0, coinjoins_1 = coinjoins; _b < coinjoins_1.length; _b++) {
                        entries = coinjoins_1[_b];
                        _loop_1(entries);
                    }
